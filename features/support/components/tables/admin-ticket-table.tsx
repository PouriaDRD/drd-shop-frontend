...
import { useAdminTickets } from "../../mutations";
import { AdminTicket, TicketCategory, TicketStatus } from "../../types";
import { AdminTicketDetailsDialog } from "../dialogs";

/* =========================
   MAIN COMPONENT
========================= */

export function AminTicketTable() {
...
function TicketRow({ ticket, index }: { ticket: AdminTicket; index: number }) {
	...
	return (
		<TableRow className="text-muted-foreground">
			...
			<TableCell className="text-center">
				<AdminTicketDetailsDialog ticket={ticket} />
			</TableCell>
		</TableRow>
	);
}
